...
class FusionSC_OneThird {
	...
	public function __construct() {
		...
		add_filter( 'fusion_attr_one-third-shortcode-wrapper', array( $this, 'wrapper_attr' ) );
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s><div %s>%s</div></div>%s', FusionCore_Plugin::attributes( 'one-third-shortcode' ), FusionCore_Plugin::attributes( 'one-third-shortcode-wrapper' ), $inner_content, $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'fusion-one-third one_third fusion-layout-column';
