...
class FusionSC_Toggle {
	...
	function render_child( $args, $content = '') {
		...
		$html = sprintf( '<div %s><div %s><h4 %s><a %s><i %s></i><div %s>%s</div></a></h4></div><div %s><div %s>%s</div></div></div>', FusionCore_Plugin::attributes( 'toggle-shortcode-panel' ),
						 ...
						 FusionCore_Plugin::attributes( 'toggle-shortcode-fa-icon' ), FusionCore_Plugin::attributes( 'fusion-toggle-heading' ), $title, FusionCore_Plugin::attributes( 'toggle-shortcode-collapse' ),
