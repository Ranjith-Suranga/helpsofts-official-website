...
class FusionSC_Blog {
	...
	function posts_container_attr() {
		...
		if ( self::$args['layout'] == 'grid' ) {
			 ...
			 $attr['style'] = sprintf( 'margin: %spx %spx 0;', $negative_margin, $negative_margin );
		}
	...
	function get_slideshow() {
		...
		if ( ! post_password_required( get_the_ID() ) && function_exists( 'avada_plugins_loaded' ) ) {
