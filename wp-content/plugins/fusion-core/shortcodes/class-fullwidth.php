<?php
	...
	class FusionSC_FullWidth {
		...
		function render( $args, $content = '' ) {
			...
			if ( empty( $defaults['padding_left'] ) && $defaults['padding_left'] != '0' ) {
			...
			if ( empty( $defaults['padding_right'] ) && $defaults['padding_right'] != '0' ) {
				$c_pageID  = FusionCore_Plugin::c_pageID();
