...
class FusionSC_OneHalf {
	...
	public function __construct() {
		...
		add_filter( 'fusion_attr_one-half-shortcode-wrapper', array( $this, 'wrapper_attr' ) );
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s><div %s>%s</div></div>%s', FusionCore_Plugin::attributes( 'one-half-shortcode' ), FusionCore_Plugin::attributes( 'one-half-shortcode-wrapper' ), $inner_content, $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'fusion-one-half fusion-layout-column';
