...
class FusionSC_TwoFifth {
	...
	public function __construct() {
		...
		add_filter( 'fusion_attr_two-fifth-shortcode', array( $this, 'attr' ) );
		add_filter( 'fusion_attr_two-fifth-shortcode-wrapper', array( $this, 'wrapper_attr' ) );		
	...
	function attr() {
		...
		$attr['class'] = 'fusion-two-fifth fusion-layout-column';
