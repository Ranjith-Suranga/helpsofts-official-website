...
class FusionSC_TwoThird {
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s><div %s>%s</div></div>%s', FusionCore_Plugin::attributes( 'two-third-shortcode' ), FusionCore_Plugin::attributes( 'two-third-shortcode-wrapper' ), $inner_content, $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'fusion-two-third fusion-layout-column';
