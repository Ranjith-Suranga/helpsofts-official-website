...
class FusionSC_OneSixth {
	...
	public function __construct() {
		...
		add_filter( 'fusion_attr_one-sixth-shortcode-wrapper', array( $this, 'wrapper_attr' ) );		
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s><div %s>%s</div></div>%s', FusionCore_Plugin::attributes( 'one-sixth-shortcode' ), FusionCore_Plugin::attributes( 'one-sixth-shortcode-wrapper' ), $inner_content, $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'fusion-one-sixth fusion-layout-column';
