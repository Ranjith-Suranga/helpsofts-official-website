...
class FusionSC_FourFifth {
	...
	public function __construct() {
		...
		add_filter( 'fusion_attr_four-fifth-shortcode-wrapper', array( $this, 'wrapper_attr' ) );		
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s><div %s>%s</div></div>%s', FusionCore_Plugin::attributes( 'four-fifth-shortcode' ), FusionCore_Plugin::attributes( 'four-fifth-shortcode-wrapper' ), $inner_content, $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'fusion-four-fifth fusion-layout-column';
