...
class FusionSC_ThreeFifth {
	...
	public function __construct() {
		...
		add_filter( 'fusion_attr_three-fifth-shortcode', array( $this, 'attr' ) );
		add_filter( 'fusion_attr_three-fifth-shortcode-wrapper', array( $this, 'wrapper_attr' ) );		
	...
	function render( $args, $content = '') {
		...
		$html = sprintf( '<div %s><div %s>%s</div></div>%s', FusionCore_Plugin::attributes( 'three-fifth-shortcode' ), FusionCore_Plugin::attributes( 'three-fifth-shortcode-wrapper' ), $inner_content, $clearfix );
	...
	function attr() {
		...
		$attr['class'] = 'fusion-three-fifth fusion-layout-column';
