...
( function($) {
	...
	**/
	fusionParser.buildCodeBlockShortocde = function( args ) {
		...
		if( !Boolean( Number( fusion_vars.disable_encoding ) ) ) {
	...
	**/
	...
	fusionParser.buildCounterBoxShortocde = function( args ) {
		...
		totalElements 	= args[10].elements.length;

		for ( i = 0; i < totalElements; i++ ){
			subElements 	= args[10].elements[i];
	...
	**/
	fusionParser.buildPersonShortocde = function( args ) {
		...
		shortcodeData+= ' pic_style_color="'+args[8].value+'"';
		shortcodeData+= ' pic_bordersize="'+args[9].value+'"';
		shortcodeData+= ' pic_bordercolor="'+args[10].value+'"';
		shortcodeData+= ' pic_borderradius="'+args[11].value+'"';
		shortcodeData+= ' social_icon_boxed="'+args[12].value+'"';
		shortcodeData+= ' social_icon_boxed_radius="'+args[13].value+'"';
		shortcodeData+= ' social_icon_colors="'+args[14].value+'"';
		shortcodeData+= ' social_icon_boxed_colors="'+args[15].value+'"';
		shortcodeData+= ' social_icon_tooltip="'+args[16].value+'"';
		shortcodeData+= ' email="'+args[17].value+'"';
		shortcodeData+= ' facebook="'+args[18].value+'"';
		shortcodeData+= ' twitter="'+args[19].value+'"';
		shortcodeData+= ' instagram="'+args[20].value+'"';
		shortcodeData+= ' dribbble="'+args[21].value+'"';
		shortcodeData+= ' google="'+args[22].value+'"';
		shortcodeData+= ' linkedin="'+args[23].value+'"';
		shortcodeData+= ' blogger="'+args[24].value+'"';
		shortcodeData+= ' tumblr="'+args[25].value+'"';
		shortcodeData+= ' reddit="'+args[26].value+'"';
		shortcodeData+= ' yahoo="'+args[27].value+'"';
		shortcodeData+= ' deviantart="'+args[28].value+'"';
		shortcodeData+= ' vimeo="'+args[29].value+'"';
		shortcodeData+= ' youtube="'+args[30].value+'"';
		shortcodeData+= ' pinterest="'+args[31].value+'"';
		shortcodeData+= ' rss="'+args[32].value+'"';
		shortcodeData+= ' digg="'+args[33].value+'"';
		shortcodeData+= ' flickr="'+args[34].value+'"';
		shortcodeData+= ' forrst="'+args[35].value+'"';
		shortcodeData+= ' myspace="'+args[36].value+'"';
		shortcodeData+= ' skype="'+args[37].value+'"';
		shortcodeData+= ' paypal="'+args[38].value+'"';
		shortcodeData+= ' dropbox="'+args[39].value+'"';
		shortcodeData+= ' soundcloud="'+args[40].value+'"';
		shortcodeData+= ' vk="'+args[41].value+'"';
		shortcodeData+= ' class="'+args[42].value+'"';
		shortcodeData+= ' id="'+args[43].value+'"]';
		shortcodeData+=   args[2].value;
		shortcodeData+= '[/person]';
