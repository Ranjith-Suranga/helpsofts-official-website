<?php
	 ...
	 */
	class TF_GridFourFifth extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element icon class
			$this->config['icon_class'] = 'fusion-icon fusion-icon-grid-4-5';
			// css class related to this element
			$this->config['css_class'] = "fusion_layout_column grid_four_fifth item-container sort-container ";
