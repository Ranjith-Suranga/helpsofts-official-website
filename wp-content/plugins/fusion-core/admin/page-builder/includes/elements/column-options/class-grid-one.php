<?php
	...
	/**
	 * One 1/6 layout category implementation, it extends DDElementTemplate like all other elements
	 */
	class TF_GridOne extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element id
			$this->config['id'] = 'grid_one';
			// element shortcode base
			$this->config['base'] = 'one_full';
			// element name
			$this->config['name'] = '1/1';
			// element icon
			$this->config['icon_url'] = "icons/sc-one.png";
			// element icon class
			$this->config['icon_class'] = 'fusion-icon fusion-icon-grid-1';
			// css class related to this element
			$this->config['css_class'] = "fusion_layout_column grid_one item-container sort-container ";
			...
			$this->config['data'] = array( "floated_width" => "1.0", "width" => "6/6", "drop_level" => "3" );
		}
		...
		//this function defines 1/6 sub elements or structure
