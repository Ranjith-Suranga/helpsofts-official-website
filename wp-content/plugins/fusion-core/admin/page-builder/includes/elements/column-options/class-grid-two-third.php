<?php
	...
	/**
	 * One 2/3 category implementation, it extends DDElementTemplate like all other elements
	 */
	class TF_GridTwoThird extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element id
			$this->config['id'] = 'grid_two_third';
			// element shortcode base
			$this->config['base'] = 'two_third';
			// element name
			$this->config['name'] = '2/3';
			// element icon
			$this->config['icon_url'] = "icons/sc-two-third.png";
			// element icon class
			$this->config['icon_class'] = 'fusion-icon fusion-icon-grid-2-3';
			// css class related to this element
			$this->config['css_class'] = "fusion_layout_column grid_two_third item-container sort-container ";
			// tooltip that will be displyed upon mouse over the element
			//$this->config['tool_tip']  		= 'Creates a single full (2/3) width column';
			...
			$this->config['data'] = array( "floated_width" => "0.66", "width" => "2/3", "drop_level" => "3" );
		}
		...
		//this function defines 2/3 sub elements or structure
		function popup_elements() {
			...
			$this->config['subElements'] = array(
				...
				array(
					"name"          => __( 'Center Content', 'fusion-core' ),
