<?php
	...
	/**
	 * One 1/5 layout category implementation, it extends DDElementTemplate like all other elements
	 */
	class TF_GridFive extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element id
			$this->config['id'] = 'grid_five';
			// element shortcode base
			$this->config['base'] = 'one_fifth';
			// element name
			$this->config['name'] = '1/5';
			// element icon
			$this->config['icon_url'] = "icons/sc-five.png";
			// element icon class
			$this->config['icon_class'] = 'fusion-icon fusion-icon-grid-5';
			// css class related to this element
			$this->config['css_class'] = "fusion_layout_column grid_five item-container sort-container";
			// tooltip that will be displyed upon mouse over the element
			//$this->config['tool_tip']  		= 'Creates a single (1/5) width column';
			...
			$this->config['data'] = array( "floated_width" => "0.2", "width" => "5", "drop_level" => "3" );
		}
		...
		//this function defines 1/5 sub elements or structure
