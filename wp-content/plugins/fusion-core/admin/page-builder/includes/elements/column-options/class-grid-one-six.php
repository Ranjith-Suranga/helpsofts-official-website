<?php
	 ...
	 */
	class TF_GridSix extends DDElementTemplate {
		...
		public function create_element_structure() {
			...
			// element id
			$this->config['id'] = 'grid_one_six';
			// element shortcode base
			$this->config['base'] = 'one_sixth';
			// element name
			$this->config['name'] = '1/6';
			// element icon
			$this->config['icon_url'] = "icons/sc-six.png";
			// element icon class
			$this->config['icon_class'] = 'fusion-icon fusion-icon-grid-6';
			// css class related to this element
			$this->config['css_class'] = "fusion_layout_column grid_six item-container sort-container ";
			...
			$this->config['data'] = array( "floated_width" => "0.16", "width" => "6", "drop_level" => "3" );
		}
