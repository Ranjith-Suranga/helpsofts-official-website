		...
		public function enqueue_admin_scripts() {
			...
			if ( in_array( $screen->id, $allowed_screens) ) {
				...
				if ( version_compare( get_bloginfo( 'version' ), '4.3', '>=' ) ) {
					...
					wp_register_script( 'fusionb_wpeditor_init', plugins_url( 'page-builder/assets/js/js-wp-editor-pre-wp43.js', __FILE__ ), array( 'jquery' ), FusionCore_Plugin::VERSION, true );
				}
