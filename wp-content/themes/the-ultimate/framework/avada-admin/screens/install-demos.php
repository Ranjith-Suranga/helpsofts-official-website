...
$demos = array( 'classic', 'agency', 'app', 'architecture', 'cafe', 'fashion', 'hosting', 'hotel', 'law', 'lifestyle', 'travel' );
?>
			...
			foreach ( $demos as $demo ) { ?>
				<div class="theme">
					<div class="theme-screenshot">
						<img src="<?php echo AVADA_ADMIN_DIR . '../assets/images/' . $demo . '_preview.jpg'; ?>" />
					</div>
					<h3 class="theme-name" id="<?php echo $demo; ?>"><?php echo 'Avada - ' . ucfirst( $demo ); ?></h3>
					<div class="theme-actions">
						...
						<?php printf( '<a class="button button-primary" target="_blank" href="%1s">%2s</a>', ( $demo != 'classic' ) ? $avada_url . $demo : $avada_url, __( "Preview", "Avada" ) ); ?>
					</div>
					<div id="demo-preview-classic" class="screenshot-hover fusion-animated fadeInUp">
						<a href="<?php echo ( $demo != 'classic' ) ? $avada_url . $demo : $avada_url; ?>" target="_blank"><img src="<?php echo AVADA_ADMIN_DIR . '../assets/images/' . $demo . '_popover.jpg'; ?>" /></a>
					</div>
