		...
		<?php while(have_posts()): the_post(); ?>
			...
			<div class="post-content">
				...
				<?php if(isset($emailSent) && $emailSent == true) { //If email is sent ?>
					<?php echo do_shortcode( '[alert type="success" accent_color="" background_color="" border_size="1px" icon="" box_shadow="yes" animation_type="0" animation_direction="down" animation_speed="0.1" class="" id=""]' .  __( 'Thank you', 'Avada' ) . ' <strong>' . $name . '</strong> ' . __( 'for using our contact form! Your email was successfully sent!', 'Avada' ) . '[/alert]' ); ?>
					<br />
				<?php } ?>
			</div>
